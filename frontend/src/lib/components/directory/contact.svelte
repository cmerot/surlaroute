<script lang="ts">
	...
	import { EmailAddress, PhoneNumber, Website } from '../icons2';

	type ContactProps = SvelteHTMLElements['div'] & { contact?: ContactPublic | null };

	let { contact, class: classNames, ...restProps }: ContactProps = $props();
