...
export type ActorAssocFeatureCollection = {
	type: "FeatureCollection";
	features: Array<ActorFeature>;
	properties: ActorAssocFeatureCollectionProperties;
};

export type ActorAssocFeatureCollectionProperties = {
	type: "tour_actors" | "event_actors";
	/**
	 * The id of the parent tour or event
	 */
	parent_id: string;
};
...
export type TourFeatureCollection = {
	type: "FeatureCollection";
	features: Array<TourLineFeature | EventPointFeature>;
...
export type TourFeatureCollectionProperties = {
	...
	event_actor_assocs: Array<ActorAssocFeatureCollection>;
};
