...
export const styles: Styles = {
		...
		style: {
			...
			sources: {
				"raster-tiles": {
					...
					tileSize: 256,
					attribution:
						'<a href="https://cyclosm.org/" target="_blank">&copy; CyclOSM</a> <a href="https://www.openstreetmap.org/copyright" target="_blank">&copy; OpenStreetMap contributors</a>',
				},
			},
			layers: [
				{
	...
	openfreemap: {
		...
		title: "OpenFreeMap Liberty (bâtiments 3D)",
	},
	ign_standard: {
		style: "https://data.geopf.fr/annexes/ressources/vectorTiles/styles/PLAN.IGN/standard.json",
		title: "IGN standard",
	},
	ign_standard_attenue: {
		style: "https://data.geopf.fr/annexes/ressources/vectorTiles/styles/PLAN.IGN/attenue.json",
		title: "IGN standard atténué",
	},
	ign_standard_no_toponymes: {
		style:
			"https://data.geopf.fr/annexes/ressources/vectorTiles/styles/PLAN.IGN/sans_toponymes.json",
		title: "IGN standard sans toponymes",
	},
	ign_standard_accentue: {
		style: "https://data.geopf.fr/annexes/ressources/vectorTiles/styles/PLAN.IGN/accentue.json",
		title: "IGN standard accentué",
	},
	ign_nb: {
		style: "https://data.geopf.fr/annexes/ressources/vectorTiles/styles/PLAN.IGN/gris.json",
		title: "IGN noir et blanc",
	},
	ign_classique: {
		style: "https://data.geopf.fr/annexes/ressources/vectorTiles/styles/PLAN.IGN/classique.json",
		title: "IGN classique",
	},
	ign_epure: {
		style: "https://data.geopf.fr/annexes/ressources/vectorTiles/styles/PLAN.IGN/epure.json",
		title: "IGN épuré",
	},
	osm_terrain_3d: {
		title: "MapLibre 3D terrain demo (OSM + terrain + shades)",
		style: {
			version: 8,
			sources: {
				osm: {
	...
	openrailwaymap: {
		title: "OpenRailwayMap (Cartes.app)",
		style: {
			version: 8,
			id: "basic-v2",
			name: "Rails",
			...
			layers: [
				...
				},
				{
					...
					filter: [
						...
						[
							"any",
							["!has", "subclass"],
							["any", ["in", "subclass", "station"], ["!in", "subclass", "station"]],
						],
					],
				},
				{
				...
				},
				{
					...
					layout: {
						"text-font": ["Noto Sans Regular"],
						"text-size": ["interpolate", ["linear", 1], ["zoom"], 3, 11, 8, 15, 11, 16, 16, 21],
						"text-field": "{name:en}",
						visibility: "visible",
						"text-max-width": 10,
					},
